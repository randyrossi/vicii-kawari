...
Trion Large w/ DVI   | [1.17 with Non-Std DVI ](https://accentual.com/vicii-kawari/downloads/flash/LG/kawari_flash_1.16_MAINLG-DVI_golden.zip) | Fallback for the large board.  (There is no RGB enabled fallback, always DVI.)
