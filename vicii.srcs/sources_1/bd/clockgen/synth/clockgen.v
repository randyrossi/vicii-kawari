...
module clockgen
   (clk_dot4x,
    reset,
    sys_clock);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_DOT4X CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_DOT4X, CLK_DOMAIN clockgen_clk_wiz_0_0_clk_ou1, FREQ_HZ 32727272, INSERT_VIP 0, PHASE 0.0" *) output clk_dot4x;
