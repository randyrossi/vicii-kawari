...
static void regs_fpga_to_vice(Vvicii* top, struct vicii_state* state) {
       ...
       state->vice_reg[0x00] = top->V_SPRITE_X[0] & 0xff;
       state->vice_reg[0x01] = top->V_SPRITE_Y[0];
       state->vice_reg[0x02] = top->V_SPRITE_X[1] & 0xff;
       state->vice_reg[0x03] = top->V_SPRITE_Y[1];
       state->vice_reg[0x04] = top->V_SPRITE_X[2] & 0xff;
       state->vice_reg[0x05] = top->V_SPRITE_Y[2];
       state->vice_reg[0x06] = top->V_SPRITE_X[3] & 0xff;
       state->vice_reg[0x07] = top->V_SPRITE_Y[3];
       state->vice_reg[0x08] = top->V_SPRITE_X[4] & 0xff;
       state->vice_reg[0x09] = top->V_SPRITE_Y[4];
       state->vice_reg[0x0a] = top->V_SPRITE_X[5] & 0xff;
       state->vice_reg[0x0b] = top->V_SPRITE_Y[5];
       state->vice_reg[0x0c] = top->V_SPRITE_X[6] & 0xff;
       ...
       state->vice_reg[0x1d] = top->V_SPRITE_XE;
       state->vice_reg[0x17] = top->V_SPRITE_YE;
       state->vice_reg[0x1e] = top->V_SPRITE_M2M;
       state->vice_reg[0x1f] = top->V_SPRITE_M2D;
       state->vice_reg[0x1d] = top->V_SPRITE_PRI;
       state->vice_reg[0x1c] = top->V_SPRITE_MMC;
       state->vice_reg[0x25] = top->V_SPRITE_MC0;
       state->vice_reg[0x26] = top->V_SPRITE_MC1;
}
