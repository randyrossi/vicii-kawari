...
#define V_SPRITE_X top__DOT__vic_inst__DOT____Vcellout__vic_registers__sprite_x
#define V_SPRITE_Y top__DOT__vic_inst__DOT____Vcellout__vic_registers__sprite_y
...
#define V_SPRITE_COL top__DOT__vic_inst__DOT____Vcellout__vic_registers__sprite_col
...
#define V_SPRITE_MC top__DOT__vic_inst__DOT____Vcellout__vic_sprites__sprite_mc
