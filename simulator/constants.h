...
#define V_IMBC_PENDING         vicii__DOT__vic_sprites__DOT__imbc_pending
#define V_IMMC         vicii__DOT__immc
#define V_IMMC_PENDING         vicii__DOT__vic_sprites__DOT__immc_pending
...
#define V_SPRITE_M2M_PENDING          vicii__DOT__vic_sprites__DOT__sprite_m2m_pending
#define V_SPRITE_M2D          vicii__DOT__sprite_m2d
#define V_SPRITE_M2D_PENDING          vicii__DOT__vic_sprites__DOT__sprite_m2d_pending
...
#define V_SPRITE_MCBASE       vicii__DOT__vic_sprites__DOT__sprite_mcbase
