...
create_clock -period 36.2 -name clk_dvi_pal
create_clock -period 3.62 -name clk_dvi10x_pal
...
set_false_path -from clk_dvi_pal -to clk_dvi10x_pal
set_false_path -from clk_dvi_ntsc -to clk_dvi10x_ntsc
