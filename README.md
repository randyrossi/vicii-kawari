...
For 1080/1084-D monitors, a CSYNC option can be enabled to output composite sync over the horizontal sync pin.  10804-S monitors use the default separated HSYNC and VSYNC signals.
